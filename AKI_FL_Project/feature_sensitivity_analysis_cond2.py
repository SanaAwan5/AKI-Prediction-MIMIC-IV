...
SITES_TO_TEST = {
    "D": {
        ...
        "unmasked_path": f"unmasked_A_and_D_0.1_1.0/site_D_{CONDITION}.csv",
    },
    "A": {
        "orig_path": f"/home/claude/work/phase3_sites_aligned/{CONDITION}/site_A_{CONDITION}.csv",
        "unmasked_path": f"unmasked_A_and_D_0.1_1.0/site_A_{CONDITION}.csv",
    },
}
SITE_C_PATH = f"unmasked_A_and_D_0.1_1.0/site_C_{CONDITION}.csv"
LABEL_COL = "AKI_label"
