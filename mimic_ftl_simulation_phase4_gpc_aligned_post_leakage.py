...
FEATURE_GROUPS: Dict[str, List[str]] = {
    ...
    "renal": [
        # hours_to_anchor deliberately NOT listed here: it was removed
        # upstream in the master-CSV notebook as part of the anchor-leakage
        # fix, so df_source never has this column and it would never match
        # regardless -- omitted here too so a future re-add upstream doesn't
        # silently reintroduce the leak with zero change needed at this level.
        "baseline_scr",
        "creatinine", "bun",
    ],
    "metabolic_panel": [
